...
export class PermissionService {
	 ...
	 */
	public async create(withDeleted: boolean, data: PermissionValidatorManageDto): Promise<PermissionCreateResult> {
	...
	public findByFilter(data: PermissionValidatorFindDto, withDeleted: boolean) {
		return this.repository
			.createQuery()
