...
export function PlaceCreateValidator() {
	return z
		.object({
			type: validateEnum(
				PlaceTypeEnum,
			...
			parent_id: z.coerce
				.number({ message: lang('place.validation.invalid_parent_id') })
				.optional(),
...
export function PlaceUpdateValidator() {
	return z
		.object({
			type: validateEnum(
				PlaceTypeEnum,
...
export function PlaceFindValidator() {
