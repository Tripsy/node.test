...
export class BrandUpdate21772079945734 implements MigrationInterface {
	name = 'BrandUpdate21772079945734';
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`CREATE UNIQUE INDEX "IDX_brand_slug" ON "brand" ("slug", "type") `,
		);
		await queryRunner.query(
