...
export class WithPlace1765731350064 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_payment_transaction_id" ON "payment" ("transaction_id") `);
        await queryRunner.query(`COMMENT ON TABLE "payment" IS 'Tracks payments from various gateways and links them to invoices.'`);
        await queryRunner.query(`ALTER TABLE "order" DROP CONSTRAINT "UQ_c12cbb238d09ce1e94dcb11fba7"`);
        ...
        await queryRunner.query(`ALTER TABLE "order" ADD "ref_number" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "order" ADD CONSTRAINT "UQ_b8f1c6f7050e71f1ddb5b40684f" UNIQUE ("ref_number")`);
        await queryRunner.query(`CREATE TYPE "public"."order_type_enum" AS ENUM('standard', 'subscription')`);
        await queryRunner.query(`ALTER TABLE "order" ADD "type" "public"."order_type_enum" NOT NULL DEFAULT 'standard'`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_order_ref_number" ON "order" ("ref_number") `);
        ...
        await queryRunner.query(`ALTER TABLE "invoice" ADD CONSTRAINT "FK_1e74a9888e5e228184769ba3dfd" FOREIGN KEY ("order_id") REFERENCES "order"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "subscription" ADD CONSTRAINT "FK_32ddbd23837b1229248a5cc232b" FOREIGN KEY ("order_id") REFERENCES "order"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "subscription_renewal" ADD CONSTRAINT "FK_a65456c4f3efacae2da403632a2" FOREIGN KEY ("subscription_id") REFERENCES "subscription"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "article_content" DROP CONSTRAINT "FK_695e2a3fb3e8f1995d703d5b91c"`);
        await queryRunner.query(`ALTER TABLE "subscription_renewal" DROP CONSTRAINT "FK_a65456c4f3efacae2da403632a2"`);
        await queryRunner.query(`ALTER TABLE "subscription" DROP CONSTRAINT "FK_940d49a105d50bbd616be540013"`);
        await queryRunner.query(`ALTER TABLE "subscription" DROP CONSTRAINT "FK_32ddbd23837b1229248a5cc232b"`);
        ...
        await queryRunner.query(`ALTER TABLE "order" DROP CONSTRAINT "UQ_b8f1c6f7050e71f1ddb5b40684f"`);
        ...
        await queryRunner.query(`ALTER TABLE "article_content" ADD "updated_at" TIMESTAMP DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "article_content" ADD "created_at" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "order" ADD "client_ref" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "order" ADD CONSTRAINT "UQ_c12cbb238d09ce1e94dcb11fba7" UNIQUE ("client_ref")`);
        ...
        await queryRunner.query(`COMMENT ON TABLE "subscription_renewal" IS NULL`);
        await queryRunner.query(`DROP INDEX "public"."IDX_subscription_renewals_status"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_subscription_renewals_invoice_id"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_subscription_renewals_subscription_id"`);
        await queryRunner.query(`DROP TABLE "subscription_renewal"`);
        await queryRunner.query(`DROP TYPE "public"."subscription_renewal_status_enum"`);
        await queryRunner.query(`COMMENT ON TABLE "subscription" IS NULL`);
        await queryRunner.query(`DROP INDEX "public"."IDX_subscription_end_at"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_subscription_status"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_subscription_ref_code"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_subscription_order_id"`);
