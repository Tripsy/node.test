...
export class BrandUpdate21772076384401 implements MigrationInterface {
	name = 'BrandUpdate21772076384401';
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`COMMENT ON COLUMN "brand_content"."meta" IS 'SEO metadata, canonical URL, images, structured data, etc.'`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE UNIQUE INDEX "IDX_brand_content_unique_per_lang" ON "brand_content" ("brand_id", "language") `,
		);
		await queryRunner.query(
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`COMMENT ON COLUMN "brand_content"."meta" IS 'SEO metadata for brand pages.'`,
		);
		await queryRunner.query(
			`ALTER TABLE "article_content" DROP COLUMN "reading_time_minutes"`,
		);
