...
// 			Configuration.settings = Configuration.loadSettings();
// 		}
// 	}
//
...
// 	static get<T = ObjectValue>(key: string): T | undefined {
// 		Configuration.init();
//
// 		const value = getObjectValue(Configuration.settings, key);
//
// 		if (value === undefined) {
// 			console.warn(`Configuration key not found: ${key}`);
// 		}
...
// 	static set(key: string, value: ObjectValue): void {
// 		Configuration.init();
//
// 		const success = setObjectValue(Configuration.settings, key, value);
//
// 		if (!success) {
// 			console.warn(`Failed to set configuration key: ${key}`);
// 		}
