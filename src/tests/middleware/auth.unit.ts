...
// 		(getAuthTokenFromHeaders as jest.Mock).mockReturnValue(undefined);
//
...
// 		(getAuthTokenFromHeaders as jest.Mock).mockReturnValue('invalid-token');
//
...
// 		(getAuthTokenFromHeaders as jest.Mock).mockReturnValue('valid-token');
//
...
// 		};
//
// 		(getAuthTokenFromHeaders as jest.Mock).mockReturnValue('valid-token-second');
//
// 		(jwt.verify as jest.Mock).mockReturnValue({
// 			user_id: 2,
// 			ident: 'ident1234',
