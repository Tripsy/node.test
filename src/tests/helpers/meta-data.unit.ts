import {compareMetaDataValue, getMetaDataValue, tokenMetaData, TokenMetadata} from '../../helpers/meta-data.helper';
...
describe('helpers/meta-data.helper.ts - Unit Tests', () => {
    ...
    describe('compareMetaDataValue', () => {
        it('should return true if values are the same for the given key', () => {
            ...
            expect(compareMetaDataValue(metadata1, metadata2, 'key')).toBe(true);
        });
        ...
        it('should return false if values are different for the given key', () => {
            ...
            expect(compareMetaDataValue(metadata1, metadata2, 'key')).toBe(false);
        });
